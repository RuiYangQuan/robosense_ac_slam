...
```
编译：
colcon build --packages-select slam --cmake-args -DPCL_DIR=/usr/lib/x86_64-linux-gnu/cmake/pcl -DEigen3_DIR=/usr/lib/cmake/eigen3 --event-handlers console_direct+
...
/opt/apps/yht/mnt/Robot/robot_mid360s_ros2
/opt/app/qry/dataset/robot_mid360s_ros2
web端话题监听
